...
public class MainActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Weather Update");
    ...
    public void findWeather()
    {
        ...
        String url ="https://api.openweathermap.org/data/2.5/weather?q="+state+"&appid=14c3311e791800aaf7f3f1ddb366f262&units=metric";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET,url,
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(MainActivity1.this,error.getLocalizedMessage(),Toast.LENGTH_SHORT).show();
            }
        });
