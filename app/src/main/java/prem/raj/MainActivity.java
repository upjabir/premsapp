...
import prem.raj.activities.StatewiseDataActivity;
import prem.raj.activities.WorldDataActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Covid-19 Status Of India");
